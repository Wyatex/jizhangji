...
// arModel is a active record design model for table income_categories operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of income_categories.
	Table = "income_categories"
	// Model is the model object of income_categories.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table income_categories.
	Columns = struct {
		Id              string //   
