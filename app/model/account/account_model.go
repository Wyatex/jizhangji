...
// arModel is a active record design model for table account operations.
type arModel struct {
	gmvc.M
}
...
var (
	...
	// Columns defines and stores column names for table account.
	Columns = struct {
		Id          string //                   
        User        string // 对应的用户id      
        Ledger      string // 对应的账本        
        Type        string // 支出：0，收入：1  
        Categories  string // 对应的分类        
        Money       string // 这笔帐的金额      
        Time        string // 这笔帐的时间
	}{
		Id:         "id",          
