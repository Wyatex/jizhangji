...
// arModel is a active record design model for table ledger operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of ledger.
	Table = "ledger"
	// Model is the model object of ledger.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table ledger.
	Columns = struct {
		Id    string //                   
        Uid   string // 对于的用户        
        Name  string // 用户的账本名      
