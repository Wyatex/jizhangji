...
package expenditure_categories
...
// arModel is a active record design model for table expenditure_categories operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of expenditure_categories.
	Table = "expenditure_categories"
	// Model is the model object of expenditure_categories.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table expenditure_categories.
	Columns = struct {
		Id              string //   
